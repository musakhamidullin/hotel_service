...
abstract class $DefectCopyWith<$Res> {
  ...
  $Res call(
      ...
      String text,
      String createDate,
      @JsonKey(name: 'hotelDefectMedias') List<ProblemMedia> hotelDefectMedias,
      String lastComment,
      int commentsCount,
      int personId,
      String personName,
...
class _$DefectImpl implements _Defect {
  ...
  @override
  String toString() {
    return 'Defect(id: $id, text: $text, createDate: $createDate, hotelDefectMedias: $hotelDefectMedias, lastComment: $lastComment, commentsCount: $commentsCount, personId: $personId, personName: $personName, statusId: $statusId, departmentId: $departmentId)';
  }
...
abstract class _Defect implements Defect {
  const factory _Defect(
      ...
      final String createDate,
      @JsonKey(name: 'hotelDefectMedias')
      final List<ProblemMedia> hotelDefectMedias,
      final String lastComment,
      final int commentsCount,
      final int personId,
      final String personName,
      final int statusId,
      final int departmentId}) = _$DefectImpl;
